...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        tests : {
            ...
            phone: function (field, data) {
                if (!this.settings.regex.phone.filter.test(data.value) || data.value.match(this.settings.regex.phone.illegalChars ) ){
                    return this.texts.phone;
                }
